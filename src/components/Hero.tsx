          ...
          <div className="w-full bg-white rounded-3xl overflow-hidden shadow-lg border border-solid border-gray-900">
            ...
            <div className="border-t border-gray-200 p-3 sm:p-4">
              ...
              <div className="sm:hidden flex flex-col items-center gap-3">
                <div className="bg-black text-white rounded-full px-6 py-2 flex items-center justify-center gap-1 transition-all duration-200 w-full opacity-50 cursor-not-allowed shadow-[0_2px_4px_rgba(0,0,0,0.25)] min-w-[120px]">
                  submit{' '}
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
